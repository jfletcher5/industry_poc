...
class AiChatActionsWidget extends StatefulWidget {
  const AiChatActionsWidget({super.key});

  @override
  State<AiChatActionsWidget> createState() => _AiChatActionsWidgetState();
}

class _AiChatActionsWidgetState extends State<AiChatActionsWidget> {
  late AiChatActionsModel _model;
